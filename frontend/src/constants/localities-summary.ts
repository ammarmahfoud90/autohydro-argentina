...
export const LOCALITIES_SUMMARY: LocalitySummary[] = [
  ...
  },
  {
    ...
    province: 'Mendoza',
    source_document: 'INA-CRA 2008 — Relaciones IDF para el pedemonte del Gran Mendoza',
    series_period: '1982–1995 (red telemétrica) + 1946–1995 (estaciones SMN) (13 años)',
